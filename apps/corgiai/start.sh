...
ALL_PROXY=socks5://localhost:1055/ HTTP_PROXY=http://localhost:1055/ http_proxy=http://localhost:1055/ API_PY_CHAT=http://$(/app/tailscale ip -4 codeblazeserver):8200 node build